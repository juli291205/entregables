...
class ManagerUsuarios {
  ...
  async addUsuario(usuario) {
    ...
    if (respuesta) {
      ...
      console.log("Existe un error al crear un usuario");
    }
  }
...
// Pruebas
const usuario1 = new Usuario("Maria", "Lopez", 25, "Backend");
const usuario2 = new Usuario("Felipe", "Lopez", 37, "Backend");
const usuario3 = new Usuario("Alejandro", "Feliz", 25, "Frontend");
